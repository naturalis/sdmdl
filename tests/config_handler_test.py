...
class ConfigHandlerTestSuite(unittest.TestCase):
    ...
    def test_create_yaml(self):
        ...
        self.assertEqual(yml[list(yml.keys())[0]],self.root + '/config_handler/data')
        self.assertEqual(yml[list(yml.keys())[1]],self.root + '/config_handler/data/occurrences')
    ...
    def test_read_yaml(self):
        ...
        self.ch.search_config()
        self.ch.read_yaml()
        self.assertEqual(self.ch.data_path,self.root + '/config_handler/data')
        self.assertEqual(self.ch.occ_path,self.root + '/config_handler/data/occurrences')
