...
class GisHandlerTestSuite(unittest.TestCase):
    ...
    def test_validate_list(self):
        ...
        self.assertEqual(f, [self.root + x for x in
                             ['/empty_land_map.tif', '/non-scaled/ecoregion/Boreal_Forests_Taiga_map.tif',
                              '/non-scaled/ecoregion/Deserts_and_Xeric_Shrublands_map.tif', '/scaled/bioclim/bio1.tif',
                              '/scaled/ecoattribute/habitat_fragmentation.tif']])
        self.assertEqual(n, ['empty_land_map', 'Boreal_Forests_Taiga_map', 'Deserts_and_Xeric_Shrublands_map', 'bio1',
    ...
    def test_validate_tif(self):
        ...
        self.assertEqual(self.gh.variables, [self.root + x for x in ['/scaled/bioclim/bio1.tif',
                                                                     '/scaled/ecoattribute/habitat_fragmentation.tif',
                                                                     '/non-scaled/ecoregion/Boreal_Forests_Taiga_map.tif',
                                                                     '/non-scaled/ecoregion/Deserts_and_Xeric_Shrublands_map.tif']])
        self.assertEqual(self.gh.names, ['bio1', 'habitat_fragmentation', 'Boreal_Forests_Taiga_map',
                                         'Deserts_and_Xeric_Shrublands_map'])
