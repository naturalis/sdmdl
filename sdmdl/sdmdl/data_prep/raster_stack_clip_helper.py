...
class raster_stack_clip_helper():
    ...
    def buff_on_globe(self, points, radius):
        ...
        """buff_on_globe function that utilizes a geoseries object and for each point creates a geodesic buffer.
        Subsequently aggregates these buffers into one final buffer object """
    ...
    def output(self):
        ...
        self.out_meta.update({"driver": "GTiff", "height": self.out_img.shape[1], "width": self.out_img.shape[2],
